      ...
      {showInfo && (
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalText}>
              🌑 <Text style={styles.bold}>Blackout / Fainting:</Text> A feeling
              of near-fainting or complete loss of consciousness.
            </Text>
            <Text style={styles.modalText}>
              😵 <Text style={styles.bold}>Lightheaded:</Text> A floating, woozy
              sensation — not quite spinning, but disorienting.
            </Text>
            <Text style={styles.modalText}>
